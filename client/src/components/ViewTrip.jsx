...
function ViewTrip() {
  ...
  return (
    <div className=" mt-12 w-full mx-auto bg-slate-50">
      {data ? (
        <div className=" w-full">
          <h2 className=" font-serif text-center mb-4 text-base font-semibold text-slate-900">
            ...
            <div className="w-full">
              <div className="max-w-sm rounded-md shadow-sm border px-4 py-2 mb-3">
                ...
                <p className="text-base font-semibold pt-2">
                  Check-In :
                  <span className="font-base text-lg pl-3">November</span>
                </p>
                <p className="pt-1">
              ...
              <div className=" mt-2" onClick={handleBooking}>
