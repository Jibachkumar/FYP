    ...
    <div>
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
          <h1 className="flex items-center text-[22px] font-extrabold text-white font-serif leading-none">
        ...
        <section className="border border-[#E5E7EB] bg-white rounded-lg p-4">
          ...
          <table className="w-full h-96 text-[13px] text-[#6B7280] border-collapse">
            <thead>
          ...
          <div className="flex justify-center mt-6 space-x-3">
            ...
            <button
              ...
              className={`rounded-md px-4 py-2 ${
                page * pageSize >= allItems.length
                  ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                  : "bg-[#E5E7EB] text-[#6B7280] hover:bg-[#D1D5DB] focus:ring-2 focus:ring-[#9b582b]"
              }`}
            >
          ...
          <div className="flex justify-center mt-1 text-[11px] text-[#6B7280]">
            <i className="fas fa-stopwatch mr-1"></i> Page {page} of{" "}
